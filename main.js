...
function mostraResultado() {
    caixaPerguntas.textContent = "De acordo com suas respostas, vocêé um cavalo..."; //Define o conteúdo de texto do elemento caixaPerguntas para informar o usuário sobre o resultado.
